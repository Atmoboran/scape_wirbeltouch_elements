...
export const STRINGS = {
    de: {
        ...
        dirUp: 'von unten',
        dirOff: 'aus',
        infoScenes: 'Fertige Aufbauten. Sie ersetzen alle Hindernisse und starten die Strömung neu. Besonders lohnend sind die Paare: Mauer gegen Lattenzaun, und ein Fenster gegen Querlüftung.',
        ...
        infoView: `Rauch zeigt die Bahnen der Luft.<br><b>Geschwindigkeit</b>: <span class="sw" style="background:#050d24"></span><span class="sw" style="background:#175c8c"></span> langsam bis <span class="sw" style="background:#f5d452"></span><span class="sw" style="background:#fa6b3d"></span> schnell, dazwischen <span class="sw" style="background:#33b89e"></span>.<br><b>Wirbelstärke</b>: <span class="sw" style="background:#ff7347"></span> dreht gegen den Uhrzeigersinn, <span class="sw" style="background:#61b8ff"></span> im Uhrzeigersinn, <span class="sw" style="background:#0a0f1a"></span> keine Drehung. Die beiden Farben wechseln sich hinter einem Zylinder ab – das ist die Wirbelstraße.<br><b>Druck</b>: <span class="sw" style="background:#ff7347"></span> Überdruck, also wo die Luft gestaut wird (Vorderseite), <span class="sw" style="background:#61b8ff"></span> Unterdruck, wo sie beschleunigt oder abreißt (Flanken und Nachlauf), <span class="sw" style="background:#0a0f1a"></span> Normaldruck. Der Unterdruck oben auf einer Tragfläche ist der Auftrieb.`,
        ...
        sceneCustom: 'Eigener Aufbau',
        sceneCanyon: 'Straßenschlucht',
        sceneWallSolid: 'Mauer, dicht',
        sceneFence: 'Lattenzaun, luftdurchlässig',
    ...
    en: {
        ...
        dirUp: 'from below',
        dirOff: 'off',
        infoScenes: 'Ready-made setups. They replace every obstacle and restart the flow. The pairs are the interesting ones: solid wall against slatted fence, and one window against cross ventilation.',
        ...
        infoView: `Smoke shows the paths the air takes.<br><b>Speed</b>: <span class="sw" style="background:#050d24"></span><span class="sw" style="background:#175c8c"></span> slow through <span class="sw" style="background:#33b89e"></span> to <span class="sw" style="background:#f5d452"></span><span class="sw" style="background:#fa6b3d"></span> fast.<br><b>Vorticity</b>: <span class="sw" style="background:#ff7347"></span> turns anticlockwise, <span class="sw" style="background:#61b8ff"></span> clockwise, <span class="sw" style="background:#0a0f1a"></span> no rotation. The two colours alternate behind a cylinder - that is the vortex street.<br><b>Pressure</b>: <span class="sw" style="background:#ff7347"></span> high, where the air piles up (the windward face), <span class="sw" style="background:#61b8ff"></span> low, where it speeds up or separates (the flanks and the wake), <span class="sw" style="background:#0a0f1a"></span> ambient. The low pressure on top of a wing is what lifts it.`,
        ...
        sceneCustom: 'Custom setup',
        sceneCanyon: 'Street canyon',
        sceneWallSolid: 'Solid wall',
        sceneFence: 'Slatted fence',
