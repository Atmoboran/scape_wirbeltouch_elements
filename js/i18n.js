...
export const STRINGS = {
    de: {
        ...
        infoMedium: 'Luft und Wasser gehorchen exakt denselben Gleichungen \u2013 unterschiedlich ist nur die Reynolds-Zahl, also das Verhältnis von Trägheit zu Zähigkeit. \u201eLuft\u201c ist auf Wind um ein Gebäude eingestellt (schnell, kräftig verwirbelt), \u201eWasser\u201c auf eine langsame Strömung im Wasserkanal (saubere, regelmäßige Wirbelstraße). Kleine Überraschung: Wasser hat die kleinere kinematische Zähigkeit \u2013 bei gleicher Größe und Geschwindigkeit wäre also Wasser das turbulentere Medium.',
    ...
    en: {
        ...
        infoMedium: 'Air and water obey exactly the same equations \u2013 what differs is the Reynolds number, the ratio of inertia to viscosity. \u201cAir\u201d is set up like wind around a building (fast, vigorously turbulent), \u201cwater\u201d like a slow flow in a water flume (a clean, regular vortex street). A small surprise: water has the lower kinematic viscosity, so at the same size and speed water would be the more turbulent one.',
